...
export function TreeAiChatDialog({ isOpen, onOpenChange, user, treeState }: TreeAiChatDialogProps) {
  ...
  const lastMessageRef = useRef<HTMLDivElement>(null); // New ref for autoscroll
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage: Message = {
        role: 'assistant',
        content:
          "My thoughts are rustling like dry leaves... I can't seem to find the right words. Please try again later.",
      };
